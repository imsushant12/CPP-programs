...
/*
// When space is not free in hash table then it will return
//next available space after the hash function calculations
int probe(int key)
{
...
void insertQuadraticProbing(int data)
{
